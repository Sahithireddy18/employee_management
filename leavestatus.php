            ...
            <div  class="container" style="height:85vh;">
                <div class="row" style="height:100%;">
                    ...
                    <div class="col-sm-15" style="height:100%;display:flex; flex-direction:column; align-items:center; justify-content:center; background:#F8F9FA;">
                      ...
                      <b>  <p align = "center"> <font size="5" color="#4285F4">Track leave status</font></p></b>
                        <hr>
...
<b>: </b> <?php
 ...
 <tr height="30"><td><b>Type of leave</b></td>
<td>
<b>: </b> <?php
                             $value1= $_SESSION["e_id"] ;
                                   $query = "select * from `leave_management` where e_id='$value1' ";
                                    $result = mysqli_query($link,$query);
                                    $row = mysqli_fetch_assoc($result);
                                    $_SESSION["e_id"] = "$value1";
                                      echo " " .$row["leave_type"]. " ";
...
<tr height="30"><td><b>Status of leave</b></td>
<td>
<b>: </b> <?php
                             $value1= $_SESSION["e_id"] ;
                                   $query = "select * from `leave_management` where e_id='$value1' ";
                                    ...
                                    if($status=='notapproved')
                                        echo "waiting to be approved by admin";
                                    //    echo "<p style='color:red;'>Sorry!your leave has been rejected</p>"
                                    else if($status=='approved')
                                        echo "your leave has been approved";
                                    else
                                        echo "Sorry!your leave has been rejected";
                                   ?></td></tr> 
