        ...
        <div class="w3-sidebar w3-bar-block w3-collapse w3-card w3-animate-left" style="width: 17%;" id="mySidebar">
            ...
            <div style="width:100%; height:15%; display:flex;">
                ...
                <div style="width:60%; display:flex; flex-direction:column; justify-content:center; font-size:12px; color:#4285F4;">
                   <p style="margin:0;"><a href="admin.php">ADMIN </a></p>
                </div>
            </div>
            <!--Navigation Items-->
            ...
            <div  class="container" style="height:100vh;">
                <div class="row" style="height:100%;">
                    ...
                    <div class="col-sm-15" style="height:100%;display:flex; flex-direction:column; align-items:center; justify-content:center; background:#F8F9FA;">
                        <div style="width:100%; height:94.5%; background:#FFF; display:flex; flex-direction:column; overflow-y:auto; overflow-x:hidden; box-shadow:2px 2px 20px #AAA;">
                            <div style="height:10%;"></div>
                            <div class = "container"  style="width:55%; height:60%; border:0px; border-radius: 10px">
                    <?php
$connect =  mysqli_connect('localhost', 'root' , '', 'majorproject');
$query = "SELECT count(e_id) as people, dept FROM `employee_data` GROUP by dept";
    ...
    function drawPieChart() {
      ...
      var data = new google.visualization.arrayToDataTable([
        ...
        for($i=0;$i<$resultCount;$i++){
          ?>[<?php echo "'".$dept[$i]."', ".$people[$i] ?>],
        <?php } 
        ?>
        ]);

      var options = {
          title: "Percentage of staff in each department",
          width: '100%',
          height: '200px',
          colors: [
            <?php
  ...
  google.charts.load("current", {packages:['corechart']});
    ...
    function drawColumnChart() {
      var data = google.visualization.arrayToDataTable([
        ...
        <?php
        for($i=0;$i<$resultCount;$i++){
          ?>[<?php echo "'".$dept[$i]."', ".$people[$i].", '".$color[$i]."' , "."'".$people[$i]."'" ?>],
        <?php } 
        ?>
        ]);
