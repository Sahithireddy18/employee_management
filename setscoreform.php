        ...
        <div class="w3-main" style="margin-left:17%; height:100vh;">
            ...
            <div  class="container" style="height:85vh;">
                <div class="row" style="height:100%;">
                    ...
                    <form name = "eid" action="setscoreaction.php" method="post" style="border:0px solid #ccc"  >
...
<tr height="40" ><td width="100"><label for="e_id"><b>Individual performance </b></label></td>
<td>
<b>: </b><input type="text" placeholder="Enter score from 1-5" name="ip" required></td>
</tr>

<tr height="40"><td  width="100"><label for="e_id"><b>Working Experience </b></label></td>
<td>
<b>: </b><input type="text" placeholder="Enter score from 1-5" name="we" required></td>
</tr>

<tr height="40"><td  width="100"><label for="e_id"><b>Experience in position</b></label></td>
<td>
<b>: </b><input type="text" placeholder="Enter score from 1-5" name="ep" required></td>
</tr>

<tr height="40" ><td  width="100"><label for="e_id"><b>Attitude </b></label></td>
<td>
<b>: </b><input type="text" placeholder="Enter score from 1-5" name="at" required></td>
</tr>

<tr height="40"><td  width="100"><label for="e_id"><b>Feedback </b></label></td>
<td>
<b>: </b><input type="text" placeholder="Enter score from 1-5" name="fp" required></td>
</tr>
...
<div class="clearfix" style="display: flex; justify-content: center;">
        ...
        function populateSidebar() {
            ...
            var links = ["viewemployees.php", "editemployees.php","addemployees.php", "removeemployees.php","leavemanagement.php","performanceadmin.php"];
