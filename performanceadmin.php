        ...
        <div class="w3-main" style="margin-left:17%; height:100vh;">
            ...
            <div  class="container" style="height:85vh;">
                <div class="row" style="height:100%;">
                    ...
                    <form name = "eid" action="performanceaction.php" method="post" style="border:0px solid #ccc"  >
                    
                      <b>  <p align = "center">Please enter the credentials to terminate an employee</p></b>
                        <hr>
