...
<html>
        ...
        <div class="w3-main" style="margin-left:17%; height:100vh;">
            ...
            <div  class="container" style="height:85vh;">
                <div class="row" style="height:100%;">
                    ...
                    <form name = "eid" action="viewbyid.php" method="post" style="border:0px solid #ccc"  >
                    
                      <b>  <p align = "center">Please enter the credentials to access data</p></b>
                        <hr>
              
                        <label for="e_id"><b>Employee ID  :</b></label>
                        <input type="text" placeholder="Enter employee id" name="e_id" required>
                        <br>  
                       <br>
    ...
    <div style="height:10%;"></div>
        ...
        function populatebody() {
            ...
            var links = ["viewempbyid.php", "viewempbydept.php","addemployees.php"];
