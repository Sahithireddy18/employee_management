        ...
        <div class="w3-main" style="margin-left:17%; height:100vh;">
            ...
            <div  class="container" style="height:85vh;">
                <div class="row" style="height:100%;">
                    ...
                    <form name = "eid" action="updateweightage.php" method="post" style="border:0px solid #ccc"  >
                    
                      <b>  <p align = "center"> Enter attribute weightages</p></b>
                        <hr>

                            <table border = "0"  align="center" style ="width:100%"  bgcolor= "#FFFAFA" > 

<tr height="50" ><td width="100"><label for="e_id"><b>Individual Performance  </b></label></td>
<td>
<b>: </b><input type="text" value="<?php
                                   ...
                                   $query = "select * from `weightages` ";
                                    ...
                                    $row = mysqli_fetch_assoc($result);
                                      ...
                                      echo " " .$row["individual_performance"]. " ";
                                   ?>"     name="ip" required></td>
</tr>

<tr height="50"><td width="100"><label for="e_id"><b>Working expeience  </b></label></td>
<td>
<b>: </b><input type="text"   value="<?php
                                   ...
                                   $query = "select * from `weightages` ";
                                    ...
                                    $row = mysqli_fetch_assoc($result);
                                      ...
                                      echo " " .$row["working_exp"]. " ";
                                   ?>"    name="we" required></td>
</tr>

<tr height="50"><td width="100"><label for="e_id"><b>Experience in position  </b></label></td>
<td>
<b>: </b><input type="text" value="<?php
                                   ...
                                   $query = "select * from `weightages` ";
                                    ...
                                    $row = mysqli_fetch_assoc($result);
                                      ...
                                      echo " " .$row["exp_inposition"]. " ";
                                   ?>"  name="ep" required></td>
</tr>

<tr height="50" ><td width="100"><label for="e_id"><b>Attitude and behaviour  </b></label></td>
<td>
<b>: </b><input type="text" value="<?php
...
<tr height="50"><td width="100"><label for="e_id"><b>Student feedback </b></label></td>
<td>
<b>: </b><input type="text" value="<?php
