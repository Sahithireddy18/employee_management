        ...
        <div class="w3-main" style="margin-left:17%; height:100vh;">
            ...
            <div  class="container" style="height:85vh;">
                <div class="row" style="height:100%;">
                    ...
                    <form name = "eid" action="addemployeesaction1.php" method="post" style="border:0px solid #ccc"  >
...
<tr height="50" ><td width="100"><label for="e_id"><b>Email  </b></label></td>
<td>
<b>: </b><input type="text" placeholder="Enter email" name="email" required></td>
</tr>

<tr height="50" ><td width="100"><label for="e_id"><b>Phone</b></label></td>
<td>
<b>: </b><input type="text" placeholder="Enter phoneNo" name="phone_number" required></td>
</tr>

<tr height="50"  ><td width="100"><label for="e_id"><b>Emergency Contact</b></label></td>
<td>
<b>: </b><input type="text" placeholder="Enter contact number" name="emergency_phno" required></td>
</tr>

<tr height="50" ><td width="100"><label for="e_id"><b>Present Address:</b></label></td>
<td>
<textarea rows="3" cols="50" placeholder="Enter Address....." name="present_address"></textarea></td>
</tr>

<tr height="50"><td width="60"><label for="e_id"><b>Permanent Address: </b></label></td>
<td>
<textarea rows="3" cols="50" placeholder="Enter Address....." name="permanant_address"></textarea>
</td>
</tr>
