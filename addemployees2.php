        ...
        <div class="w3-main" style="margin-left:17%; height:100vh;">
            ...
            <div  class="container" style="height:85vh;">
                <div class="row" style="height:100%;">
                    ...
                    <form name = "eid" action="addemployeesaction2.php" method="post" style="border:0px solid #ccc"  >
...
<tr height="50" ><td width="100"><label for="e_id"><b>Qualification  </b></label></td>
<td>
<b>: </b><input type="text" placeholder="Enter qualification" name="qualification" required></td>
</tr>

<tr height="50" ><td width="100"><label for="e_id"><b> Position Hired</b></label></td>
<td>
<b>: </b><input type="text" placeholder="Enter hired position" name="position_hired" required></td>
</tr>

<tr height="50"  ><td width="100"><label for="e_id"><b>Status</b></label></td> 
<td>
<b>: </b><input type="text" placeholder="Active/Inactive" name="status" required></td>
</tr>

<tr height="50" ><td width="100"><label for="e_id"><b>Hired date </b></label></td>
<td>
<b>: </b><input type="text" placeholder="dd/mm/yyyy" name="hired_date" required></td>
</tr>

<tr height="50"><td width="60"><label for="e_id"><b>Teaching Experience </b></label></td>
<td>
<b>: </b><input type="text" placeholder="Enter Experience" name="teaching_exp" required></td>
</tr>

<tr height="50"><td width="60"><label for="e_id"><b>Industry Experience </b></label></td>
<td>
<b>: </b><input type="text" placeholder="Enter Experience" name="industrial_exp" required></td>
</tr>
