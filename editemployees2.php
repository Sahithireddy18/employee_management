        ...
        <div class="w3-main" style="margin-left:17%; height:100vh;">
            ...
            <div  class="container" style="height:85vh;">
                <div class="row" style="height:100%;">
                    ...
                    <form name = "eid" action="updateaction1.php" method="post" style="border:0px solid #ccc"  >
...
<tr height="50" ><td width="100"><label for="e_id"><b> Position current</b></label></td>
<td>
<b>: </b><input type="text" value="<?php
                             $value1= $_SESSION["editid"] ;
                                   $query = "select * from `job_details` where e_id='$value1' ";
...
<tr height="50" ><td width="100"><label for="e_id"><b>Resign date </b></label></td>
<td>
<b>: </b><input type="text" align="left" value="<?php
                             $value1= $_SESSION["editid"] ;
                                   $query = "select * from `job_details` where e_id='$value1' ";
...
<div class="clearfix" style="display: flex; justify-content: center;">
                     ...
                     <form action="editemployees3.php">
                            <div class="clearfix" style="display: flex; justify-content: center;">
