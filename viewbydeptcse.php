...
$dep='cse';
$sql = "SELECT e_id, e_name FROM employee_data where dept='$dep'";
$result = $conn->query($sql);

if ($result->num_rows > 0) {
    echo "<table><tr ><th style='padding-left: 350px;color:#4285F4;height:60'>ID</th><th style='padding-left: 35px; color:#4285F4;height:60'>Name</th></tr>";
    // output data of each row
    while($row = $result->fetch_assoc()) {
        echo "<tr ><td style='width:33%;padding-left: 350px; valign=center;height:60'>".$row["e_id"]."</td><td style='width:33%;padding-left: 35px; valign=center;height:60'>".$row["e_name"]."</td></tr>";
    }
    echo "</table>";
} else {
    echo "0 results";
