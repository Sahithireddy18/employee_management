        ...
        <div class="w3-main" style="margin-left:17%; height:100vh;">
            ...
            <div  class="container" style="height:85vh;">
                <div class="row" style="height:100%;">
                    ...
                    <form name = "eid" action="updateaction2.php" method="post" style="border:0px solid #ccc"  >
...
<tr height="40"><td><label for="e_id"><b>Email </b></label></td>
<td>
<b>: </b><input type="text"   value="<?php
                             $value1= $_SESSION["editid"] ;
...
<tr height="40"><td><label for="e_id"><b>Phone </b></label></td>
<td>
<b>: </b><input type="text" value="<?php
                             $value1= $_SESSION["editid"] ;
                                   $query = "select * from `contact_details` where e_id='$value1' ";
                                   ...
                                   ?>"  name="phno" required></td>
</tr>

<tr height="40"><td><label for="e_id"><b>Emergency Contact </b></label></td>
<td>
<b>: </b><input type="text" value="<?php
                             $value1= $_SESSION["editid"] ;
                                   $query = "select * from `contact_details` where e_id='$value1' ";
                                   ...
                                   ?>"  name="ephno" required></td>
</tr>
<tr height="40" ><td><label for="e_id"><b>Present Address  </b></label></td>
<td>
<b>: </b><input type="text" value="<?php
                             $value1= $_SESSION["editid"] ;
                                   $query = "select * from `contact_details` where e_id='$value1' ";
                                   ...
                                   ?>" name="presentadd" required></td>
</tr>

<tr height="40"><td><label for="e_id"><b>Permanent Address </b></label></td>
<td>
<b>: </b><input type="text" value="<?php
                             $value1= $_SESSION["editid"] ;
                                   $query = "select * from `contact_details` where e_id='$value1' ";
...
<div class="clearfix" style="display: flex; justify-content: center;">
                          ...
                          <form action="editemployees4.php">
                            <div class="clearfix" style="display: flex; justify-content: center;">
