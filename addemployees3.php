        ...
        <div class="w3-main" style="margin-left:17%; height:100vh;">
            ...
            <div  class="container" style="height:85vh;">
                <div class="row" style="height:100%;">
                    ...
                    <form name = "eid" action="addemployeesaction3.php" method="post" style="border:0px solid #ccc"  >
                    
                      <b>  <p align = "center"> Enter employee Personal data here</p></b>
                        <hr>

                            <table border = "0"  align="center" width="100" style ="width:100%"  bgcolor= "#FFFAFA" > 

<tr height="40" ><td width="100"><label for="e_id"><b>Employee ID  </b></label></td>
<td>
<b>: </b><input type="text" placeholder="Enter employee id" name="e_id" required></td>
</tr>

<tr height="50" ><td width="100"><label for="e_id"><b>Name </b></label></td>
<td>
<b>: </b><input type="text" placeholder="Enter Name" name="e_name" required></td>
</tr>

<tr height="50" ><td width="100"><label for="e_id"><b>Father Name</b></label></td>
<td>
<b>: </b><input type="text" placeholder="Enter father name" name="father_name" required></td>
</tr>

<tr height="50"  ><td width="100"><label for="e_id"><b>Date of Birth</b></label></td> 
<td>
<b>: </b><input type="text" placeholder="dd/mm/yyyy" name="status" required></td>
</tr>

<tr height="50" ><td width="100"><label for="e_id"><b>Gender</b></label></td>
<td>
<b>: </b><input type="radio"  name="gender"  required>Female
<input type="radio"  name="gender"  required>Male
</td>
</tr>

<tr height="50"><td width="60"><label for="e_id"><b>Blood Group </b></label></td>
<td>
<b>: </b>
...
<tr height="50"><td width="60"><label for="e_id"><b>Nationality </b></label></td>
<td>
<b>: </b><input type="text" placeholder="Indian..." name="nationality" required></td>
</tr>


<tr height="50"><td width="60"><label for="e_id"><b>Religion</b></label></td>
<td>
<b>: </b><input type="text" placeholder="enter religion" name="religion" required></td>
</tr>  

<tr height="50"><td width="60"><label for="e_id"><b>Caste </b></label></td>
<td>
<b>: </b><input type="text" placeholder="enter caste" name="caste" required></td>
</tr>

<tr height="50"><td width="60"><label for="e_id"><b>Marital Status </b></label></td>
<td>
<b>: </b><input type="radio"  name="gender"  required>Yes
<input type="radio"  name="gender"  required>No</td>
</tr>

<tr height="50"><td width="60"><label for="e_id"><b>Spouse Name </b></label></td>
<td>
<b>: </b><input type="text" placeholder="enter name" name="spouse_name" required></td>
</tr>

<tr height="50"><td width="60"><label for="e_id"><b>Occupation</b></label></td>
<td>
<b>: </b><input type="text" placeholder="enter occpation" name="occpation" required></td>
</tr>

<tr height="50"><td width="60"><label for="e_id"><b>Organization Name </b></label></td>
<td>
<b>: </b><input type="text" placeholder="enter organization" name="organization" required></td>
</tr>

<tr height="50"><td width="60"><label for="e_id"><b>Dependentants:</b></label></td>
<td>
<textarea rows="2" cols="20" placeholder="Enter Dependentants....." name="address"></textarea></td>
</tr>

<tr height="50"><td width="60"><label for="e_id"><b>PAN Number </b></label></td>
<td>
<b>: </b><input type="text" placeholder="enter pan number" name="pan_number" required></td>
</tr>

<tr height="50"><td width="60"><label for="e_id"><b>Aadhar Number</b></label></td>
<td>
<b>: </b><input type="text" placeholder="enter aadhar number" name="aadhar_number" required></td>
</tr>

<tr height="50"><td width="60"><label for="e_id"><b>Driving license Number </b></label></td>
<td>
<b>: </b><input type="text" placeholder="enter license number" name="license_number" required></td>
</tr>

<tr height="50"><td width="60"><label for="e_id"><b>Bank Name </b></label></td>
<td>
<b>: </b><input type="text" placeholder="enter bank name" name="bank_name" required></td>
</tr>

<tr height="50"><td width="60"><label for="e_id"><b>Bank Account Name </b></label></td>
<td>
<b>: </b><input type="text" placeholder="enter name" name="bankacc_name" required></td>
</tr>

<tr height="50"><td width="60"><label for="e_id"><b>Bank Account Number </b></label></td>
<td>
<b>: </b><input type="text" placeholder="enter account number" name="bankacc_number" required></td>
</tr>
