            ...
            <div  class="container" style="height:85vh;">
                <div class="row" style="height:100%;">
                    ...
                    <div class="col-sm-15" style="height:100%;display:flex; flex-direction:column; align-items:center; justify-content:center; background:#F8F9FA;">
                      ...
                      <b>  <p align = "center">Please enter the credentials to access data</p></b>
                        <hr>
                        <div class="container" style="padding-left:37%;">
  
  <div class="dropdown" >
    <center>
    <button class="btn btn-primary dropdown-toggle" type="button" data-toggle="dropdown">Choose Department
    <span class="caret"></span></button>
    <ul class="dropdown-menu">
      <li><a href="viewbydeptcse.php">CSE</a></li>
      <li><a href="viewbydeptit.php">ECE</a></li>
      <li><a href="viewbydeptit.php">IT</a></li>
    </ul>
  </div>
</div>

    <div style="height:10%;"></div>
                            <div id="menubar" style="width:100%; height:15%; display:flex; border:1px solid #E6EBF1;">
                <div style="width:2%; height:100%; background:#4285F4"></div>
                <div style="width:93%; height:100%; display:flex; justify-content:flex-start; align-items:center; font-size:20px; padding-left:32%; color:#74838B;"></div>
                <div style="width:5%; height:100%; display:flex; justify-content:flex-start; align-items:center; font-size:20px; padding-right:12%; color:#74838B;">&gt;</div>
            </div>
        ...
        function populatebody() {
            var items = ["View Employees using ID", "View Employees using Dept", "View Employees using Recruitment Type"];
            var links = ["viewemployees.php", "editemployees.php","addemployees.php"];
            
            var sidebarItemModel = document.getElementById("menubar");
            for(itemNo in items) {
                var item = items[itemNo];
                sidebarItemModel.children[0].style.visibility = "hidden";
                sidebarItemModel.children[1].innerHTML = "<a href='"+links[itemNo]+"'>"+item+"</a>";
