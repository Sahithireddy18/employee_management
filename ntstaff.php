            ...
            <div  class="container" style="height:85vh;">
                <div class="row" style="height:100%;">
                    ...
                    <div class="col-sm-15" style="height:100%;display:flex; flex-direction:column; align-items:center; justify-content:center; background:#F8F9FA;">
                      ...
                      <b>  <p align = "center"> <font size="2" color="#4285F4">The list employees who are eligible for Garment pay scale for current month</font></p></b><br>
...
$dep='cse';
$sql = "SELECT e_id FROM job_details  where (year(SYSDATE())-year(hired_date))>0 and (MONTH(SYSDATE())-MONTH(hired_date))=0;";
$result = $conn->query($sql);

if ($result->num_rows > 0) {
    echo "<table><tr ><th style='padding-left: 70px;color:#4285F4;height:60'>ID</th><th style='padding-left: 35px; color:#4285F4;height:60'>Name</th></tr>";
    // output data of each row
    while($row = $result->fetch_assoc()) {
        echo "<tr ><td style='width:33%;padding-left: 70px; valign=center;height:60'>".$row["e_id"]."
        </tr>";
    }
    echo "</table>";
} else {
