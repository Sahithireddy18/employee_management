        ...
        <div class="w3-sidebar w3-bar-block w3-collapse w3-card w3-animate-left" style="width: 17%;" id="mySidebar">
            ...
            <div style="width:100%; height:15%; display:flex;">
                <div style="width:40%; display:flex; justify-content:flex-end; align-items:center;">
                    <img src="users.png" style="border-radius:50%; width:60%; margin-right:4%;"/>
                </div>
        ...
        <div class="w3-main" style="margin-left:17%; height:100vh;">
            ...
            <div  class="container" style="height:85vh;">
                <div class="row" style="height:100%;">
                    ...
                    <form  action="applyforleaveaction.php" method="post" style="border:0px solid #ccc"  >
                    
                      <b>  <p align = "center"> <font size="5" color="#4285F4">Apply for leave</font></p></b>
                        <hr>

                            <table border = "0"  align="center" style ="width:100%"  bgcolor= "#FFFAFA" > 

<tr height="50"><td width="60"><label for="e_id"><b>Leave Type </b></label></td>
<td>
<b>: </b>
<select name="leave_type">
  <option value="casual">casual</option>
  <option value="sick">sick leave</option>
  <option value="vacational">vactional</option>
  <option value="pregnancy">pregnancy leave</option>
...
<tr height="40"><td><label for="e_id"><b>From date </b></label></td>
<td>
<b>: </b><input type="text" placeholder="dd/mm/yyyy" name="from_date" required></td>
</tr>

<tr height="40"><td><label for="e_id"><b>To date  </b></label></td>
<td>
<b>: </b><input type="text" placeholder="dd/mm/yyyy" name="to_date" required></td>
</tr>

<tr height="50" ><td width="100"><label for="e_id"><b>Description:</b></label></td>
<td>
<textarea rows="3" cols="50" placeholder="Enter Description....." name="description"></textarea></td>
</tr>
...
<div class="clearfix" style="display: flex; justify-content: center;">
        ...
        function populateSidebar() {
           var items = [ "ApplyforLeave","Latest leavestatus","Performance Analysis"];
            var links = [ "applyforleave.php","leavestatus.php","#"];
